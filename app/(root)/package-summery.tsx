...
import { ChevronLeftIcon, PencilIcon, ExclamationCircleIcon, MapPinIcon } from "react-native-heroicons/outline";
...
const PackageSummaryScreen = () => {
  return (
    <ScrollView className="flex-1 bg-white p-4">
      ...
      {/* Title */}
      <Text className="text-xl font-DMSansSemiBold mt-8">Your Package Summary</Text>
      <Text className="text-gray-500 font-DMSansRegular mb-4">
        Here is your final package summary, please go through it and update if any information is incorrect.
      </Text>
      ...
      <View className="mb-4">
        ...
        <View className="ml-4">
          ...
          <View className="flex-row items-center justify-between">
            <Text className="text-gray-700"> <MapPinIcon className='h-4 w-4'/> Home (Delivery Point)</Text>
      ...
      <View className="mb-4">
        ...
        <View className="ml-4">
          <Text className="text-gray-700 mb-2">Package Content: Clothes & Personal Items</Text>
          <Text className="text-gray-700 mb-2">Package Description: Box / Carton</Text>
      ...
      <View className="mb-4">
        ...
        <View className="ml-4">
          <Text className="text-gray-700 mb-2">Receiver's Name: Deepak Deori</Text>
          <Text className="text-gray-700">Receiver's Phone-number: +91 9876543627</Text>
        </View>
      </View>
      ...
      <CustomButton title='Proceed to pay'  />
    </ScrollView>
  );
};
